-- Black Phantom Gamble-Eyes Skull
...
function s.tgfilter(c,val)
  return c:IsRace(RACE_ZOMBIE) and c:IsType(TYPE_MONSTER) and (c:GetAttack()==val or c:GetDefense()==val) and c:IsAbleToGrave()
end
...
function s.cfilter(c,e,tp)
  return (c:IsRace(RACE_ZOMBIE) or c:GetPreviousRaceOnField()&RACE_ZOMBIE~=0)
