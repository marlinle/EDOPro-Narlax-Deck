...
function s.fusfilter2(c,fc,sumtype,tp)
	return c:IsAttribute(ATTRIBUTE_DARK,fc,sumtype,tp) and c:IsType(TYPE_SYNCHRO,fc,sumtype,tp)
end
function s.fusfilter3(c,fc,sumtype,tp)
	return c:IsAttribute(ATTRIBUTE_DARK,fc,sumtype,tp) and c:IsType(TYPE_XYZ,fc,sumtype,tp)
end
...
function s.spfilter(c,e,tp,rp)
	...
	return c:IsAttribute(ATTRIBUTE_DARK,fc,sumtype,tp) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
